...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/jack/crazyflie/sim-to-real-TD3/ros/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/jack/crazyflie/sim-to-real-TD3/ros/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /home/jack/crazyflie/sim-to-real-TD3/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jack/crazyflie/sim-to-real-TD3/ros/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jack/crazyflie/sim-to-real-TD3/ros/devel/.private/catkin_tools_prebuild/lib;/home/jack/catkin_ws/devel/lib;/opt/ros/noetic/lib)
