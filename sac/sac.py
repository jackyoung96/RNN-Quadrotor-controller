...
class SAC_Trainer():
    ...
    def update(self, batch_size, gamma=0.99,soft_tau=1e-3):
        ...
        # Critic update
        q_value_loss1 = ((predicted_q_value1 - target_q_value.detach())**2).sum()  # detach: no gradients for the variable
        q_value_loss2 = ((predicted_q_value2 - target_q_value.detach())**2).sum()  
